        ...
        child: Row(
          ...
          children: <Widget>[
            Column(children: <Widget>[
              Text("Total Pesanan", style: Theme.of(context).textTheme.title,),
              SizedBox(height: 4,),
              Text(totalItem.toString() + " bungkus", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
            ],),
            Column(children: <Widget>[
              Text("Total Harga Pesanan", style: Theme.of(context).textTheme.title,),
              SizedBox(height: 4,),
